...
function Row({ title, movies }: Props) {
  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y-2">
      <h2
        className="w-46 cursor-pointer text-sm font-semibold text-[#e5e5e5] 
      ...
      <div className="group relative">
        <ChevronLeftIcon
          ...
          opacity-0 transtiton hover:scale-125 group-hover:opacity-100 ${
            !isMoved && "hidden"
          }`}
        ...
        <ChevronRightIcon
         ...
         transtiton hover:scale-125 group-hover:opacity-100"
